...
#SBATCH -J "Scrape_${FILE_NAME}"   # job name using the parameter
#SBATCH --mail-user=bhx5gh@virginia.edu  # email address
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --account=uvailp           # allocation name
#SBATCH -o ijobLogs/scrape_${FILE_NAME}.out
#SBATCH -e ijobLogs/scrape_${FILE_NAME}.err

# Activate virtual environment and run the scraper
source .venv/bin/activate
cd ScrapingNewsSources
python scrape_newspaper.py ${FILE_NAME} -o "/scratch/bhx5gh/IndependentStudy/ScrapingResults/" -q ""
EOF
